...
class Calendar(object):
    ...
    def valid_date(self, date, exchange_market='SSE'):
        date = int(date)
        trade_days = self.__calendar_dict[exchange_market]
        if not trade_days[0] <= date <= trade_days[-1]:
...
class Meta(object):
    def __init__(self):
        ...
        self.begin_trading_day = 0
        self.end_trading_day = 0
        self.begin_di = 0
        self.end_di = 0
        self.di_size = 0
        self.di_list = []
        ...
        self.back_days = 0
        # self.valid_begin_trading_day = 0
        # self.valid_begin_di = 0
        # self.valid_di_size = 0

        self.matrix_back_days = 0
        self.max_back_days = 0

        self.instrument_index = {}
        self.ii_mapping = {}
        self.ii_size = 0
        self.last_instrument_index = []
        self.all_instrument_index = []
        self.ii_list = []
        ...
        self.check_save_di = None
        self.check_load_di = None
