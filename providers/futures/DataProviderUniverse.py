...
#   static.pi  int64 di×ii, 槽位所属品种 id (= ii // 50), 全槽填充
...
from DataProviderFuturesCommon import FUTURES_CC_DIR, SLOTS_SIZE, HOT_SLOT
...
class Provider(MssqlProvider):
    ...
    def generate(self):
        ...
        pi_buffer = np.tile(np.arange(self.meta.ii_size, dtype=np.int64) // SLOTS_SIZE,
                            (self.meta.di_size, 1))
