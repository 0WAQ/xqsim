...
#
# 用法: python DataProviderMetaUpdater.py [meta_dir]   (默认 $XQSIM_DATA_HOME/futures/cc)
import bisect
import json
import os
import sys
...
from DataProviderFuturesCommon import (FUTURES_CC_DIR, SLOTS_SIZE, HOT_SLOT, convert_product,
