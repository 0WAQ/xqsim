...
class Provider(StaticProvider):
    ...
    def generate_xqsim_uv(self):
        ...
        self.write_data("%s.%s" % (self.abbr, "xqsim_all"), buffer)
    ...
    def generate(self):
        ...
        self.generate_xqsim_uv()


def main():
    builder_run(meta_dir=STOCKS_CC_DIR, begin_date=20130104, end_date="TODAY-1", output_cache_dir=STOCKS_UPDATE_DIR)
