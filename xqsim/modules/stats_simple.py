import ksim.data.Universe as uv
from ksim.data import DataRegistry as dr
from ksim.stats import StatsBase
from ksim.utils import Oputil
import numpy as np
import os
from ksim import Checkpoint as cpt
import pickle
...
class StatsSimple(StatsBase):
    ...
    def calculate(self, di):
        ...
        idx_lmt = 0 #(self.ops[di] >= self.uplmt[di] - 0.01) | (self.ops[di] <= self.lolmt[di] + 0.01)
        nPos[idx_lmt] = np.nan
