...
class Stats(StatsBase):
    def __init__(self, *args):
        ...
        self.norm_mode = simcfg.get(self.cfg, "norm", -1)
        if self.norm_mode != -1:
        ...
        if self.benchmark is not None:
            ...
            self.top_n = simcfg.get(self.cfg, "top", -1)
            if self.top_n >= 0:
                self.norm_mode = -1
        ...
        self.trade_price = simcfg.get(self.cfg, "trade_price", "vwap")
