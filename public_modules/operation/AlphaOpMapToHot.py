"""Map product-slot alpha values to the target day's hot contracts."""
...
class Operation(OperationBase):
    def __init__(self, *args):
        ...
        self.real_contract_mask = (slot < HOT_DATA_SLOT) & (industry >= 0)
        self.hot = self.dr.get_data("hot.ii")
        self.universe = self.dr.get_data("uv.all")
        log_info("MapToHot: products %d", int(self.hot_data_mask.sum()))
